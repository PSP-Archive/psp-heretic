...
extern boolean		print_resource_pwad_error;
...
//        if (!netgame)
        {
            V_DrawPatch(160, viewwindowy + 5, 0, W_CacheLumpName(DEH_String("PAUSED"),
                                                              PU_CACHE));
        }
/*
        else
        {
            V_DrawPatch(160, 70, 0, W_CacheLumpName(DEH_String("PAUSED"), PU_CACHE));
        }
*/
    }
...
void D_PageDrawer(void)
{
    ...
    if (demosequence == 1)
    {
        V_DrawPatch(4, 160, 0, W_CacheLumpName(DEH_String("ADVISOR"), PU_CACHE));
    }
...
/*static*/ void D_Endoom(void)
{
    ...
    if(error_detected)
	endoom_data = W_CacheLumpName(DEH_String("ERROR"), PU_STATIC);
    else
...
*/
    ...
    FILE *fprw = fopen("./pspheretic.wad","rb");
	...
	printf("          PLEASE COPY THE FILE 'PSPHERETIC.WAD' WHICH CAME          ");
	printf("            WITH THIS RELEASE, INTO THE GAME'S DIRECTORY            ");
   	printf("\n");
	printf("                         QUITTING NOW ...                           ");
	printf(" ================================================================== ");
	...
	printf("\n\n\n\n\n\n\n\n\n\n\n\n\n");
	printf(" ================================================================== ");
	printf("     WARNING: RESOURCE PWAD FILE 'PSPHERETIC.WAD' IS MISSING!!!     ");
...
*/
    ...
    if (load_extra_wad == 1 && (HERETIC_REG_1_0 || HERETIC_REG_1_2 || HERETIC_REG_1_3))
	D_AddFile(extra_wad);

    D_AddFile("pspheretic.wad");
